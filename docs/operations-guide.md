# Advanced Network Observability — Operations Guide

> Detailed build, deployment, verification, demo and troubleshooting commands.
> Return to the [project overview](../README.md).

Run all relative commands from the repository root unless a section says
otherwise.
...
from analytics and alert-manager. See [architecture.md](architecture.md).
...
[ckad-checklist.md](ckad-checklist.md).
...
manual presentation order is documented in [ckad-checklist.md](ckad-checklist.md).
